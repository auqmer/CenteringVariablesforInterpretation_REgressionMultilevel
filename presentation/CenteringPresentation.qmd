...
plot(y ~ x, type = "n", xlim = c(-1, 7), main = "Without Random Slopes")
abline(a = 1, b = .2)
abline(a = 2, b = .2)
abline(a = 3, b = .2)
abline(v = 0, col = "red")
abline(v = 3, col = "red")
brackets(0,1,0,3, curvature = 1)
brackets(3,1.6,3,3.6, curvature = 1)

plot(y ~ x, type = "n", xlim = c(-1, 7), main = "With Random Slopes")
abline(a = 1, b = .2)
abline(a = 2, b = .4)
abline(a = 3, b = .6)
abline(v = 0, col = "red")
abline(v = 3, col = "red")
brackets(0,1, 0,3, curvature = 1)
brackets(3,1.6, 3,4.8, curvature = 1)
